...
def setup_self_healing_prompt_template():
    ...
    You are tasked with debugging failing unit tests generated by LLM. Below is the *** Information *** given about the *** Input Code Base ***.
    ...
    function_code: This is the original code of the one function being tested.
    function_common_code: The common portion of the code which is common or same for all the functions in a single .py file.
    generated_test_function_name: This is the generated test function name by LLM.
    test_function_code: This is the generated unit test code by LLM.
    test_error: This includes the error messages and traceback from running the generated test code with the help of ** pytest ** framework.
    
    
    Follow the given *** Instructions *** precisely and sequentially. 
    
    ### Instructions ###
    
    ++ Analyze the provided function_code, function_common_code, test_function_code, and test_error.
    ++ Identify the root cause of the test failures mentioned on the test_error.
    ...
    {
        "corrected_common_code": Generate the corrected common code here,
        "corrected_test_code" : Generate the corrected test code here
    }
