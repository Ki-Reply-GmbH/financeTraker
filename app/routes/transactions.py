...
from services.transaction_services import get_all_transactions_by_user, get_catagory_by_id, create_catagory, create_new_transaction, get_all_catagories, create_categories
...
user_id = current_user["user"].id.__index__()
